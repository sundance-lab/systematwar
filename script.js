...
const CONFIG = {
    ...
    MIN_STAR_MULTIPLIER: 100,   // Min sun size: ORIGINAL_STAR_RADIUS * 75 (1500px)
    MAX_STAR_MULTIPLIER: 200,  // Max sun size: ORIGINAL_STAR_RADIUS * 150 (3000px)

    // Planet Properties
    PLANET_RADIUS_MIN_BASE: 30,
    PLANET_RADIUS_MAX_BASE: 80,
